...
const App = () => {
  ...
  if (audioRef.current){
    audioRef.current.ontimeupdate=async function(){
 ...
 return (
    <SongContext.Provider value={{ track, setTrack, audioRef, playStatus, setPlayStatus, playSong, duration,currentTime, seekBarRef }}>
